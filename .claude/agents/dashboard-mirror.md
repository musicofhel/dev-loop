...
All dashboard-mirror work happens in `~/dashboard-mirror`. The source code, prompts, and output all live there.
...
Read the prompt template at `~/dashboard-mirror/prompts/baseline.md` and follow it exactly.
...
**Output**: `~/dashboard-mirror/output/_baseline/baseline-report.md`
...
Read the prompt template at `~/dashboard-mirror/prompts/analyst-structure.md`.
...
**Output**: `~/dashboard-mirror/output/<slug>/analyst-structure.md`

### Analyst B — Data & Labels

Read the prompt template at `~/dashboard-mirror/prompts/analyst-data.md`.
...
**Output**: `~/dashboard-mirror/output/<slug>/analyst-data.md`

### Analyst C — UX & Polish

Read the prompt template at `~/dashboard-mirror/prompts/analyst-ux.md`.
...
**Output**: `~/dashboard-mirror/output/<slug>/analyst-ux.md`

## Phase 4: Synthesis

After all 3 analysts complete for a dashboard, run the synthesizer.

Read the prompt template at `~/dashboard-mirror/prompts/synthesizer.md`.
...
**Output**: `~/dashboard-mirror/output/<slug>/grounding.md`

## Rules

### Always
- Read the full prompt template from `~/dashboard-mirror/prompts/` before starting each analysis phase
